...
cmd({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://i.imghippo.com/files/JgI8278ypg.jpg", {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            mediaUrl: "https://i.imghippo.com/files/JgI8278ypg.jpg", // Static image URL
            sourceUrl: "https://wa.me/923143702270?text=*Hi+👑𝐋𝚫𝐃𝐋𝚫+𝐒𝚯𝚵𝚰𝐊𝚯👑*",
